# -*- coding: utf-8 -*-
"""
Created on Mon Mar  8 21:06:25 2021
...
from keras.layers import Conv2D, Reshape, Cropping2D
from keras.layers import BatchNormalization, Activation, concatenate, add
...
def u2net_2d(input_size, n_labels, filter_num_down, filter_num_up='auto', filter_mid_num_down='auto', filter_mid_num_up='auto', 
    ...
    * Upsampling is achieved through bilinear interpolation and can be replaced by transpose convolutional layers here.
    ...
    #D = Cropping2D(cropping=(190,190), data_format="channels_last")(D)
    D = Reshape((input_size[0], input_size[0]))(D)
    
    
    #output = Cropping2D(cropping=(256,256), data_format="channels_last")([D,])
...
if __name__=='__main__':
    # test unet
    model = u2net_2d((256, 256, 1),1,[64, 128])
    ## 143:333, 
    model.summary()
